    	...
    	<div class="row">
        	<div class="col-md-12">
            	<div class="box">
                    ...
                    <div class="box-body">
						<form id="dynamicForm" action="<?php echo base_url('admin/service/update_admissionnews/');?>" enctype="multipart/form-data" method="POST">
                          ...
                          <input type="hidden" name="id" value="<?php echo $id; ?>">
                                        ...
                                        <div >
                                            ...
                                            <div class="input-row">
                                                <div class="input-field">
                                                    <input type="text" placeholder="Exam Name" name="exam_name" value="<?php echo $blog_desc['exam_name']; ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                            ...
                                            <!-- Initial row -->
                                            <?php if (!empty($schedule['Exam_Particulars'])): ?>
                                             <?php foreach ($schedule['Exam_Particulars'] as $key => $event): ?>
                                            <div class="input-row">
                                                <div class="input-field">
                                                    <input type="text" placeholder="Exam Particulars" name="Exam_Particulars[]" value="<?= $event; ?>" required>
                                                </div>
                                                <div class="input-field">
                                                    <input type="text" placeholder="Exam Details" name="ExamDetails[]" value="<?= $schedule['ExamDetails'][$key]; ?>" required>
                                                </div>
                                      ...
                                      <div id="inputContainer1">
                                            ...
                                            <div class="input-row">
                                                <div class="input-field">
                                                    <input type="text" placeholder="Events" name="Events[]" value="<?= $event; ?>" required>
                                                </div>
                                                <div class="input-field">
                                                    <input type="text" placeholder="Dates" name="Dates[]" value="<?= $schedule['Dates'][$key]; ?>" required>
                                                </div>
                                      ...
                                      <div id="inputContainer2">
                                            <!-- Initial row -->
                                             <?php if (!empty($schedule['EntranceExam'])): ?>
                                             <?php foreach ($schedule['EntranceExam'] as $key => $event): ?>
                                            <div class="input-row">
                                                <div class="input-field">
                                                    <input type="text" placeholder="Entrance Exam" name="EntranceExam[]"  value="<?= $event; ?>" required>
                                                </div>
                                                <div class="input-field">
                                                    <input type="text" placeholder="Eligibility Criteria" name="EligibilityCriteria[]" value="<?= $schedule['EligibilityCriteria'][$key]; ?>"  required>
                                                </div>
                                        ...
                                        <div id="inputContainer3">
                                            <!-- Initial row -->
                                             ...
                                             <?php foreach ($schedule['Sections'] as $key => $event): ?>
                                            <div class="input-row">
                                                <div class="input-field">
                                                    <input type="text" placeholder="Sections" name="Sections[]" value="<?= $event; ?>" required>
                                                </div>
                                                <div class="input-field">
                                                    <input type="text" placeholder="Allotted Time" name="AllottedTime[]" value="<?= $schedule['AllottedTime'][$key]; ?>"  required>
                                                </div>
                                                <div class="input-field">
                                                    <input type="text" placeholder="Questions" name="Questions[]" value="<?= $schedule['Questions'][$key]; ?>" required>
                                                </div>
                                        ...
                                        <div id="inputContainer4">
                                            <!-- Initial row -->
                                              <?php if (!empty($schedule['RegistrationProcess'])): ?>
                                             <?php foreach ($schedule['RegistrationProcess'] as $key => $event): ?>
                                            <div class="input-row">
                                                <div class="input-field">
                                                    <input type="text" placeholder="Registration Process" name="RegistrationProcess[]"  value="<?= $event; ?>"  required>
                                                </div>
                                        ...
                                        <div id="inputContainer5">
                                            <!-- Initial row -->
                                              <?php if (!empty($schedule['DocumentsRequired'])): ?>
                                             <?php foreach ($schedule['DocumentsRequired'] as $key => $event): ?>
                                            <div class="input-row">
                                                <div class="input-field">
                                                    <input type="text" placeholder="Documents Required" name="DocumentsRequired[]" value="<?= $event; ?>" required>
                                                </div>
                                        ...
                                        <div id="inputContainer6">
                                            <!-- Initial row -->
                                             <?php if (!empty($schedule['Nameprogram'])): ?>
                                             <?php foreach ($schedule['Nameprogram'] as $key => $event): ?>
                                            <div class="input-row">
                                                <div class="input-field">
                                                    <input type="text" placeholder="Name Program" name="Nameprogram[]" value="<?= $event; ?>" required>
                                                </div>
                                                <div class="input-field">
                                                    <input type="text" placeholder="Campus" name="Campus[]" value="<?= $schedule['Campus'][$key]; ?>" required>
                                                </div>
                                                  <div class="input-field">
                                                    <input type="text" placeholder="Seats" name="Seats[]" value="<?= $schedule['Seats'][$key]; ?>" required>
                                                </div>
                                        ...
                                        <div id="inputContainer7">
                                            <!-- Initial row -->
                                             <?php if (!empty($schedule['Program'])): ?>
                                             <?php foreach ($schedule['Program'] as $key => $event): ?>
                                            <div class="input-row">
                                                <div class="input-field">
                                                    <input type="text" placeholder="Program" name="Program[]" value="<?= $event; ?>" required>
                                                </div>
                                                <div class="input-field">
                                                    <input type="text" placeholder="Fees" name="fee[]" value="<?= $schedule['fee'][$key]; ?>" required>
                                                </div>
