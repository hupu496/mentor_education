        	...
        	<div class="col-md-12">
            	<div class="box">
                	<div class="box-header with-border">
                    	<div class="box-title">
                        	<a href="<?php echo base_url('admin/service/courses_blog_desclist') ;?>">
                            	<button class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Courses Blog Description List</button>
                        	</a>
                        </div>
                        <!--<div class="pull-right"><a href="" class="btn btn-sm btn-primary"> STAFF LIST </a></div>-->
                    </div>
                    <div class="box-body">
						<form id="dynamicForm" action="<?php echo base_url('admin/service/insert_courses_blog_desc/');?>" enctype="multipart/form-data" method="POST">
                        	<div class="row form-group">
                                <div class="col-md-1"></div>
                                <div class="col-sm-12 col-md-12">
                                    <div class="row form-group">
                                        <label class="col-sm-12 col-md-2 col-form-label">Courses <span class="text-danger">*</span></label>
