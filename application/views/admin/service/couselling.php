    	...
    	<div class="col-md-12">
        	<div class="box">
            	<div class="box-header with-border">
                	<div class="box-title">
                      <a href="<?php echo base_url('admin/service/add_couselling') ;?>">
                        ...
                        <?php
                        	...
                        	<tr>
								...
								<td><img src="<?php echo file_url($list['image']);?>" width="100" height="60" ></td>
							      <td ><?php echo $list['url_link']; ?></td>
                                <td >
                                   <a  href='<?php echo base_url("admin/service/couselling_edit/$list[id]") ;?>' class="btn btn-sm btn-success" ><i class="fa fa-edit"></i> Edit </a>
                                </td>
                            </tr>
                            <?php
                                    }
