                ...
                <div class="row row-cols-1 row-cols-md-2 g-4">
                    ...
                    <div class="col">
                        <div class="card article-card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <a href="#" class="text-decoration-none">AACCC Ayush PG Counselling 2024: Get All Details Here</a>
                                </h5>
                                <p class="text-muted small">No Comments | 07-10-2024</p>
                                <p class="card-text">AACCC PG Counselling 2024 Schedule For BAMS Ayurveda PG Admission For All India Quota: First Round AACCC Ayush PG Counselling 2024 Schedule: Events Dates Verification</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="card article-card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <a href="#" class="text-decoration-none">MP Online Ayush Counselling 2024 (State Quota) Started: Get All Details Here</a>
                                </h5>
                                <p class="text-muted small">No Comments | 05-10-2024</p>
                                <p class="card-text">MP Ayush Counselling 2024 Schedule For BAMS/ BHMS/ BUMS/ BNYS Courses Admission (State Quota Seats): First Round Counselling Schedule of MP BAMS Admission 2024 (State...</p>
                            </div>
                        </div>
                    </div>
                </div>
